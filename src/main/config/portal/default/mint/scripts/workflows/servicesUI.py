...
class ServicesUIData:
    ...
    def _updatePackageMetadata(self, progressStep = False):
        ...
        try:
            ...
            jsonConfigFile = systemConfig.getObject(["portal", "packageTypes", "servicesUI"]).get("jsonconfig")
    ...
    def _getDataConfig(self):
        ...
        jsonConfigFileString = systemConfig.getObject(["portal", "packageTypes", "servicesUI"]).get("jsonconfig")
